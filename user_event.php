...
<head>
    ...
    <title>Think Cafe - Reserved event</title>
...
<body>
    ...
    <h1 class="animate-up delay-1">ตารางการจองกิจกรรม</h1>
    <table border="1" id="reservedTable" class="animate-up delay-2">
        ...
        <?php
            ...
            // ดึงข้อมูลการจอง
            $sql = "SELECT id, event, username, phonenum, guests, date, time, status FROM event_cm WHERE username = ? ORDER BY id DESC";
